...
import static eeg.bigdata.hadoop.movingaverage.Constants.INPUT_METRIC_CONFIGURATION_NAME;
import static eeg.bigdata.hadoop.movingaverage.Constants.INPUT_SID_CONFIGURATION_NAME;
import static eeg.bigdata.hadoop.movingaverage.Constants.OUTPUT_RID_CONFIGURATION_NAME;

public class OpenTSDBAsciiOutputFormat extends TextOutputFormat<LongWritable, DoubleWritable> {

    protected static class OpenTSDBAsciiWriter extends RecordWriter<LongWritable, DoubleWritable> {
        ...
        public synchronized void write(LongWritable key, DoubleWritable value)
                throws IOException {
    ...
    public RecordWriter<LongWritable, DoubleWritable>
